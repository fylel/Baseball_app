  ...
  useEffect(() => {
    sets.forEach(async (set) => {
      ...
      try {
        ...
        const API = import.meta.env.VITE_API_URL || 'http://127.0.0.1:8000'
        const url = `${API}/api/pitches?year=${queryYear}&pitcherId=${pId}&batterId=${bId}&pitcherRole=${pitcherRole}&pitchType=${ptParam}&zone=${zParam}&balls=${bParam}&strikes=${sParam}`
  ...
  return (
    ...
    >
      <div style={{ minHeight: '100vh', background: '#0d1117', display: 'flex', flexDirection: 'column' }}>
        ...
        {/* Sub-header: batter selector + status */}
        <div style={{
